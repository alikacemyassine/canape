...
```
<body>
  -S-- #preloader         (fixed, z-9999, dark fullscreen)
  -S-- <nav>              (fixed, z-50, glass-nav)
  -S-- <main>
  -   -S-- .hero-section  (100vh, full-bleed image, z-1)
  -   --- .main-content  (z-2, bg-background, sits above hero on scroll)
  -       -S-- Categories Section  (pinned GSAP scroll)
  -       -S-- Brand Quote Section
  -       --- <footer>
```
